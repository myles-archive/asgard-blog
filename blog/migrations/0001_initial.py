...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_posts', (
            ...
            ('send_pings', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        # Adding unique constraint on 'Post', fields ['slug', 'published']
        db.create_unique('blog_posts', ['slug', 'published'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Post', fields ['slug', 'published']
        db.delete_unique('blog_posts', ['slug', 'published'])
    ...
    models = {
        ...
        'blog.post': {
            'Meta': {'ordering': "('-published', '-date_added')", 'unique_together': "(('slug', 'published'),)", 'object_name': 'Post', 'db_table': "'blog_posts'"},
            ...
            'send_pings': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
